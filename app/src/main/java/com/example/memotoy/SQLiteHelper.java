...
public class SQLiteHelper {
    ...
    private class OpenHelper extends SQLiteOpenHelper{
        ...
        public OpenHelper(@NonNull Context context, @NonNull String name, @Nullable SQLiteDatabase.CursorFactory factory, int version){
    ...
    // DELEFT FROM MemoTable WHERE seq = x;
